...
body{background-image: url(https://pbs.twimg.com/media/EId7pQsU0AAca8l?format=png&name=900x900)}
</style>
<body>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="beranda">
    <h1 class="w3-jumbo" style="text-align:right; color:#f44336"><b>Enrica Sevilla</b></h1>
...
<label style= "color:color:#f44336"> Nama: <input type="text" name="nama"></label><br>
NIM: <input type="text" name="nim"><br>
Nomor Telepon: <input type="text" name="no_telp"><br>
Alamat: <input type="text" name="alamat"><br>
E-mail: <input type="text" name="Email"><br>
Dosen Wali: <input type="text" name="doswal"><br>

<h2 style= "color:#f44336"><b>Data Orang Tua</b></h2>
Nama Ayah: <input type="text" name="nim"><br>
Nomor Telpon: <input type="text" name="alamat"><br>
Alamat: <input type="text" name="Email"><br>
