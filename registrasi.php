        ...
        <div class="card-body py-3" style="background-color: rgba(255, 0, 0, 0.7);" id="form">
            ...
            <form role="form" method="POST" action="">
                ...
                <div class="form-group my-3">
                    ...
                    <input type="password" name="kata_sandi1" id="kata_sandi1" class="form-control" placeholder="Password" required="required">
                </div>
                <div class="form-group my-3">
                    <label for="kata_sandi" style="color: white">Ulangi Password</label>
                    <input type="password" name="kata_sandi2" id="kata_sandi2" class="form-control" placeholder="Password" required="required">
                </div>
                <select name="level" id="level" class="mb-3">
                ...
                <button type="submit" name="register" class="w3-button w3-block w3-grey">
                    <div class="text-center" style="color: black">REGISTRASI</div>
                </button>
            </form>
            <br>
        </div>
