          ...
          <div class="tab-content">
            ...
            <hr style="width:50px;border:5px solid red" class="w3-round">
                  <form class="form" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" disabled class="form-control" value="<?php echo $teleponku ?>">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="email"><h4>Dosen Wali</h4></label>
                              <input type="text" class="form-control" disabled value="<?php echo $doswalku ?>">
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                              <label for="password"><h4>Nama Ayah</h4></label>
                              <input type="text" class="form-control" disabled value="<?php echo $namaAyah ?>" >
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                            <label for="password2"><h4>No Telepon Ayah</h4></label>
                              <input type="text" class="form-control" disabled value="<?php echo $noAyah ?>">
                          </div>

                          <div class="col-xs-6">
                            <label for="password2"><h4>Alamat Ayah</h4></label>
                              <input type="text" class="form-control" disabled value="<?php echo $alamatAyah ?>">
                          </div>
                      </div>
             ...
             <div class="tab-pane" id="messages">
               ...
               <hr style="width:50px;border:5px solid red" class="w3-round">
               <form class="form"  method="POST" action="aksi_updatemhs.php">
                      <div class="form-group">
                          <div class="col-xs-6">
                              <label for="first_name"><h4>Nama</h4></label>
                              <input type="text" class="form-control" value="<?php echo $_SESSION['nama'] ?>" disabled>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="phone"><h4>Phone</h4></label>
                              <input type="text" name="no_telp_mahasiswa2" class="form-control" value="<?php echo $teleponku ?>">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="email"><h4>Dosen Wali</h4></label>
                              <input type="text" class="form-control" readonly name="doswal_mahasiswa2" value="<?php echo $doswalku ?>">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="password"><h4>Nama Ayah</h4></label>
                              <input type="text" class="form-control" name="ayah_mahasiswa2" value="<?php echo $namaAyah ?>" >
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="password2"><h4>No Telepon Ayah</h4></label>
                              <input type="text" class="form-control" name="ayah_no_telepon2" value="<?php echo $noAyah ?>">
                          </div>

                          <div class="col-xs-6">
                            <label for="password2"><h4>Alamat Ayah</h4></label>
                              <input type="text" class="form-control" name="ayah_alamat2" value="<?php echo $alamatAyah ?>">
                          </div>
                      </div>
