...
$sql8 = "SELECT id_daftarta, nim, dosenpenguji, nama, tema, statuspenguji1 FROM daftarta WHERE dosenpenguji='$namaDosen' and id_daftarta='$id' ";
...
<center>
    <section class="col-lg-4 col-12 px-0 shadow">
        ...
        <div class="card-body py-3" style="background-color: rgba(255, 0, 0, 0.7);" id="form">
            ...
            <form  method="POST" action="aksi_edit_jadwalseminarTA.php">
