...
$sql8 = "SELECT * FROM daftarta WHERE dosbing='$namaDosen' and id_daftarta='$id' ";
...
<center>
    <section class="col-lg-4 col-12 px-0 shadow">
        ...
        <div class="card-body py-3" style="background-color: rgba(255, 0, 0, 0.7);" id="form">
            ...
            <form  method="POST" action="aksi_edit_daftarta.php">
                <div class="form-group my-3">
                <label for="no_induk" style="color: white" >ID Pendaftaran TA</label>
