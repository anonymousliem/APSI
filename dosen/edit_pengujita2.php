...
$sql8 = "SELECT id_daftarsempro, nim, dosenpenguji2, nama, tema, status2 FROM daftarsempro WHERE dosenpenguji2='$namaDosen' and id_daftarsempro='$id' ";
...
<center>
    <section class="col-lg-4 col-12 px-0 shadow">
        ...
        <div class="card-body py-3" style="background-color: rgba(255, 0, 0, 0.7);" id="form">
            ...
            <form  method="POST" action="aksi_edit_pengujianta2.php">
