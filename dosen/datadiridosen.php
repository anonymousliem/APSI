...
<?php 
	if(isset($_GET['pesan'])){
        ...
        else if($_GET['pesan'] == "berhasilupdatedata"){
...
<center>
    <section class="col-lg-4 col-12 px-0 shadow">
        ...
        <div class="card-body py-3" style="background-color: rgba(255, 0, 0, 0.7);" id="form">
            ...
            <form role="form" method="POST" action="aksi_tambahdatadiridosen.php">
                ...
                <div class="form-group my-3">
                    <label for="text" style="color: white">Alamat</label>
                    <input type="text" name="alamat" id="alamat" class="form-control" placeholder="alamat" required="required">
                </div>
                <div class="form-group my-3">
                    <label for="kata_sandi" style="color: white">email</label>
                ...
                <button type="submit" name="register" class="w3-button w3-block w3-grey">
                    <div class="text-center" style="color: black">TAMBAH DOSEN</div>
                </button>
            </form>
            <br>
